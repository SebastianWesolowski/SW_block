...
import { faqBackground } from './styled-faq-background';
import backgroundImage from './assets/faq-background.jpg';
import blockGlobalConst from '../../global-block-consts';

const divStyle = {
	backgroundImage: 'url(' + blockGlobalConst.srcDist + backgroundImage + ')',
};
...
export const edit = ( props ) => {
	...
	return (
		<div className={ faqBackground.faq } style={ divStyle }>
			<div className={ faqBackground.wrapper }>
				<div className={ faqBackground.title }>
					<span className={ faqBackground.img }>
						<svg
