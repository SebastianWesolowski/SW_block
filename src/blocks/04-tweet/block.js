...
( function() {
	...
	const Editable = wp.blocks.Editable; // Editable component of React.
	...
	registerBlockType( 'gb/tweet-04', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		...
		save: function( props ) {
			...
			const tweetContent = props.attributes.content; // Content in our block.
			// Console Log.
			console.log( 'tweetContent: ', tweetContent );

			const tweetURI = 'https://twitter.com/home?status=' + encodeURIComponent( tweetContent ); // Encodes a Uniform Resource Identifier (URI) component — https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent.
			const attrs = {
				href: tweetURI,
